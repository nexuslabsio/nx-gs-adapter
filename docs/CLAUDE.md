...
Feature specs live in `docs/specs/NNN-<feature>.md` (spec-only) or `docs/specs/NNN-<feature>/spec.md` (when a feature carries extra docs — `tech.md`, `flow.md`, a `.plan/`, etc.); `NNN` is a zero-padded sequential id.

Any spec change (new spec, rename, added feature) updates this table in the same pass.

| #   | Feature                           | Date       | File                                                   |
| --- | --------------------------------- | ---------- | ------------------------------------------------------ |
| 001 | adapter-bootstrap                 | 2026-04-27 | [spec](specs/001-adapter-bootstrap/spec.md)            |
...
| 004 | jdbc-connection-source            | 2026-04-28 | [spec](specs/004-jdbc-connection-source/spec.md)       |
| 005 | cdc-engine                        | 2026-04-29 | [spec](specs/005-cdc-engine/spec.md)                   |
| 006 | runtime-sync                      | 2026-05-01 | [spec](specs/006-runtime-sync/spec.md)                 |
| 007 | per-server-sync                   | 2026-05-02 | [spec](specs/007-per-server-sync/spec.md)              |
| 008 | messaging                         | 2026-05-06 | [spec](specs/008-messaging/spec.md)                    |
| 009 | commands                          | 2026-05-07 | [spec](specs/009-commands/spec.md)                     |
| 010 | commands-send-mail                | 2026-05-08 | [spec](specs/010-commands-send-mail/spec.md)           |
| 011 | events-online-snapshot            | 2026-05-09 | [spec](specs/011-events-online-snapshot/spec.md)       |
| 012 | snapshot-persistence              | 2026-05-17 | [spec](specs/012-snapshot-persistence/spec.md)         |
| 013 | character-core-extension          | 2026-05-17 | [spec](specs/013-character-core-extension/spec.md)     |
