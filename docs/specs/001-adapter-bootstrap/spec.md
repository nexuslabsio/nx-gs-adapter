...
- [done] R18. **Threading model — adapter-owned daemon threads.** Every long-running
  ...
  `uncaughtExceptionHandler` installed:
    ...
    - `nx-events-publisher` — bounded-queue drainer for outbound events
      (see [`messaging`](../008-messaging/spec.md))
...
- Server-side `/connect`:
  [
  `nx-tenants/docs/specs/001-server-registration/spec.md`](../../../../nx-tenants/docs/specs/001-server-registration/spec.md)
- Server-side Kafka creds delivery:
  [
  `nx-tenants/docs/specs/002-tenant-registration/spec.md`](../../../../nx-tenants/docs/specs/002-tenant-registration/spec.md)
