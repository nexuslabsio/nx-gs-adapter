...
> - [`commands`](../009-commands/spec.md) — Kafka topic + consumer + dispatch table +
    > reply path + heartbeat slot. UNCHANGED by this slice.
> - [`adapter-modules`](../002-adapter-modules/spec.md) — Tier-1 ServiceLoader-based
...
- Companion document:
  [`docs/specs/010-commands-send-mail/tech.md`](./tech.md) — wire layout + handler walkthrough
