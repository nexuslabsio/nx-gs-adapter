...
> - [`db-sync`](../db-sync/spec.md) / [`cdc-engine`](../cdc-engine/spec.md) —
    > CDC mapping, `hashedColumns`, whole-DTO emit on change. UNCHANGED.
> - [`olympiad-events`](../olympiad-events/spec.md) — the `events.olympiad`
...
- Parent: [`character-core-extension`](../character-core-extension/spec.md)
- Backlog drained: [`character-deferred-fields.md`](../../character-deferred-fields.md)
- Event family extended: [`olympiad-events`](../olympiad-events/spec.md)
- CDC mechanism: [`db-sync`](../db-sync/spec.md), [`cdc-engine`](../cdc-engine/spec.md)
