...
- [done] R6. Adapter restart семантика: после рестарта
  ...
  (см. `nx-gameservers/docs/features/character-core-extension/spec.md`
  R10).
...
- Parent feature: [`docs/features/db-sync/spec.md`](../db-sync/spec.md) —
  CDC мapping для `CharacterDbDto`.
- Parent feature: [`docs/features/runtime-sync/spec.md`](../runtime-sync/spec.md) —
  runtime engine для `CharacterRuntimeDto`.
- Deferred backlog: [`character-deferred-fields.md`](../../character-deferred-fields.md).
- Platform side: `nx-gameservers/docs/features/character-core-extension/`.
