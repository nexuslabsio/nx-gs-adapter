...
class RaidDropItemTest {
    ...
    void getEnchantLevel_shouldBeNullable() {
        RaidDropItem drop =
                RaidDropItem.builder().itemId(57).count(100_000_000L).build();
    ...
    void builder_shouldPopulateAllFields() {
        RaidDropItem drop =
                RaidDropItem.builder().itemId(6660).count(1L).enchantLevel(5).build();
    ...
    void toBuilder_shouldRoundtrip() {
        RaidDropItem original =
                RaidDropItem.builder().itemId(6660).count(1L).enchantLevel(8).build();
    ...
    void equals_shouldDistinguishEnchantLevel() {
        RaidDropItem a =
                RaidDropItem.builder().itemId(1).count(1L).enchantLevel(0).build();
        RaidDropItem b =
                RaidDropItem.builder().itemId(1).count(1L).enchantLevel(1).build();
