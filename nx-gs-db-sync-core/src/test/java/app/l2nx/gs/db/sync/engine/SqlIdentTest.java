...
class SqlIdentTest {
    ...
    void validate_shouldRejectHostileOrMalformedIdentifiers(String name) {
        IllegalStateException ex =
                assertThrows(IllegalStateException.class, () -> SqlIdent.validate(name, "primary.tableName"));
    ...
    void validate_shouldRejectNull() {
        assertThrows(IllegalStateException.class, () -> SqlIdent.validate(null, "primary.pkColumn"));
    }
    ...
    void validate_shouldRejectIdentifierExceeding64Chars() {
        ...
        assertThrows(IllegalStateException.class, () -> SqlIdent.validate(sb.toString(), "col"));
    }
}
